...
const IntervalQuery = () => {
    ...
    const { isLoading, isError, data, error } = useQuery<Uuid, Error>('intervalQuery', async () => {
    ...
    if(isLoading) {
        let loadingProps = { label: 'Loading...', progress: 5 };
    ...
    let loadingProps = { label: data?.uuid || 'Loading...', progress: 5 };
